...
- `elroy-app` + `elroy-db` + `elroy-agenda`: active/inactive due-item query behavior, Python-style timed-due prompt surfacing, heuristic contextual-trigger surfacing, Python-named active due-item inspection, plus file-backed due-item create/update/rename/complete/delete flows
