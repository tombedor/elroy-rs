...
- `elroy-app` + `elroy-db` + `elroy-agenda`: active due-item query behavior, Python-style timed-due prompt surfacing, heuristic contextual-trigger surfacing, plus file-backed due-item create/update/rename/complete/delete flows
