...
- `elroy-cli`: CLI TUI adapter behavior for deferred context-refresh background worker scheduling plus failure surfacing into the shared background-status/footer path
